...
local colors = {
  '#2E3440', -- ?
  '#D8DEE9', -- 2. Menu, clock, inactive tags
  '#A3BE8C', -- 3. Menu active, focused tags
  '#2E3440', -- 4. Background of everything
  '#EBCB8B', -- 5. Occupied tag
  '#2E3440', -- 6. Borders
  '#88C0D0', -- 7. Random minor things
  '#ffe261', -- 8. Warnings
