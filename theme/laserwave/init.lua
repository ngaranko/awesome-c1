...
local colors = {
  '#91889b', -- 1. Menu main text (clock, inactive windows)
  '#716385', -- 2. Menu empty (empty tags)
  '#EB64B9', -- 3. Menu active (focused tags)
  '#27212e', -- 4. Menu background (Background of everything)
  '#ffffff', -- 5. Menu text (occupied tag)
  '#716385', -- 6. Borders
  '#b381c5', -- 7. Random minor things
  '#ffe261'  -- 8. Warnings
}
...
t.notification_shape = function(cr,w,h) return shape.rounded_rect(cr,w,h,0) end
